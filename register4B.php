...
?>	
 ...
 <form method="post" action="register4B.php">
...
<option value="liril"<?php if($currency=="liril") {echo "selected";}?>> Liril</option>
 ...
 <table> <tr> <th> Genre Name</th> <th> Track Name</th><th></th> <th> Composer</th><th></th></tr>
 <?php
 $query = "Select genre.Name as genreName, track.name as trackName, composer from genre join track limit 10";
 $result = mysqli_query($conn,$query);
 // check for errors
     if (!$result) {
		 die(mysqli_error($conn));
 ...
 <td>
 <form method="post" action="register4B.php">
 <input type="submit" name="submit" value="Add This Track List">
 </form></td></tr>
 ...
 <?php
	...
	<a href="index4B.php"> Show My Total</a>
